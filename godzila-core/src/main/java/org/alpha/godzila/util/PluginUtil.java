...
import static org.alpha.godzila.constants.ConstantValue.*;
...
public class PluginUtil {
    ...
    public static String getPluginClassName(String pluginName, OperatorType operatorType) {
        ...
        switch (operatorType) {
            ...
            default:
                throw new GodzilaRuntimeException("unknown operatorType: " + operatorType);
        }
        ...
        if (contextClassLoader instanceof URLClassLoader) {
            ...
            for (URL url : urLs) {
                ...
                distributeCachedFiles.put(
                        name,
                        CompletableFuture.completedFuture(new Path(path)));
            }
