...
package org.alpha.godzila.sql.parser;

import org.alpha.godzila.throwable.GodzilaSqlParseException;
import org.alpha.godzila.util.PwdUtil;
import org.alpha.godzila.util.Splitter;
                ...
                .forEach(
                        stmt -> {
                            try {
                                ...
                                throw new GodzilaSqlParseException(
