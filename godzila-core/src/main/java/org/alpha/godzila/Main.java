 ...
 */
package org.alpha.godzila;

import org.alpha.godzila.cdc.CdcConfig;
import org.alpha.godzila.cdc.RestorationFlatMap;
...
import org.alpha.godzila.config.OperatorConfig;
import org.alpha.godzila.config.SpeedConfig;
import org.alpha.godzila.config.SyncConfig;
import org.alpha.godzila.constants.ConstantValue;
...
import org.alpha.godzila.enums.ClusterMode;
import org.alpha.godzila.enums.EJobType;
import org.alpha.godzila.environment.EnvFactory;
import org.alpha.godzila.environment.MyLocalStreamEnvironment;
import org.alpha.godzila.mapping.MappingConfig;
import org.alpha.godzila.mapping.NameMappingFlatMap;
import org.alpha.godzila.options.OptionParser;
import org.alpha.godzila.options.Options;
import org.alpha.godzila.sink.SinkFactory;
import org.alpha.godzila.source.SourceFactory;
import org.alpha.godzila.sql.parser.SqlParser;
import org.alpha.godzila.throwable.GodzilaRuntimeException;
import org.alpha.godzila.throwable.JobConfigException;
import org.alpha.godzila.util.*;
...
import static org.alpha.godzila.enums.EJobType.SQL;
    ...
    public static void main(String[] args) throws Exception {
        ...
        switch (EJobType.getByName(options.getJobType())) {
            ...
            case SYNC:
                ...
                break;
            default:
                throw new GodzilaRuntimeException(
                        "unknown jobType: ["
                                + options.getJobType()
