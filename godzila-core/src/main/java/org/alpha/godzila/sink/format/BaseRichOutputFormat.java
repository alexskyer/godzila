...
package org.alpha.godzila.sink.format;

import org.alpha.godzila.cdc.DdlRowData;
import org.alpha.godzila.cdc.config.DDLConfig;
import org.alpha.godzila.cdc.exception.LogExceptionHandler;
import org.alpha.godzila.cdc.handler.DDLHandler;
import org.alpha.godzila.cdc.utils.ExecutorUtils;
...
import org.alpha.godzila.factory.GodzilaThreadFactory;
...
import static org.alpha.godzila.metrics.BaseMetric.DELAY_PERIOD_MILL;
import static org.alpha.godzila.metrics.BaseMetric.DELAY_PERIOD_MILL_KEY;
        ...
        if (batchSize > 1 && flushIntervalMills > 0) {
            ...
            this.scheduler =
                    new ScheduledThreadPoolExecutor(
                            1, new GodzilaThreadFactory("timer-data-write-thread"));
    ...
    protected void checkTimerWriteException() {
        if (null != timerWriteException) {
            if (timerWriteException instanceof NoRestartException) {
                ...
                throw new GodzilaRuntimeException("Writing records failed.", timerWriteException);
            }
        }
    }
