...
import org.alpha.godzila.element.column.ArrayColumn;
import org.alpha.godzila.element.column.NullColumn;
import org.alpha.godzila.throwable.GodzilaRuntimeException;
import org.alpha.godzila.typeutil.serializer.AbstractColumnSerializerUtil;
                ...
                switch (elementType.getTypeRoot()) {
                    ...
                    case DOUBLE:
                        return ArrayColumn.from(
                                ...
                                true);
                    default:
                        throw new GodzilaRuntimeException("Unknown primitive type: " + elementType);
                }
            } else {
