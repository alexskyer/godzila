 ...
 */
package org.alpha.godzila.connector.jdbc.util;
...
public class JdbcUtil {
    ...
    public static Connection getConnection(JdbcConfig jdbcConfig, JdbcDialect jdbcDialect) {
        ...
        ClassUtil.forName(
                jdbcDialect.defaultDriverName().orElseThrow(() -> new GodzilaRuntimeException("")),
    ...
    public static void checkTableExist(Connection dbConn, TableIdentify tableIdentify) {
        try {
            ...
            throw new GodzilaRuntimeException("failed to check table exist", throwable);
        }
    }
    ...
    public static Pair<List<String>, List<TypeConfig>> getTableMetaData(
        ...
        try (Statement st = dbConn.createStatement();
            ...
            throw new GodzilaRuntimeException("failed to retrieve table metadata", e);
        }
    }
