...
import org.alpha.godzila.connector.jdbc.util.SqlUtil;
...
import org.alpha.godzila.metrics.BigIntegerAccumulator;
import org.alpha.godzila.metrics.StringAccumulator;
                ...
                try {
                    ...
                    if (!dbConn.isValid(3)) {
                        ...
                        if (!dbConn.isValid(3)) {
                            ...
                            throw new GodzilaRuntimeException(message);
                        }
                    }
                    ...
                    String message =
                            String.format(
                                    ...
                                    state,
                                    ExceptionUtil.getErrorMessage(e));
                    throw new GodzilaRuntimeException(message, e);
                }
            }
            return true;
        }
