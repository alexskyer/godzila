...
import org.alpha.godzila.connector.ftp.spliter.ConcurrentFileSplitFactory;
import org.alpha.godzila.connector.ftp.converter.FtpSqlConverter;
...
import org.alpha.godzila.source.format.BaseRichInputFormat;
import org.alpha.godzila.throwable.ReadRecordException;
import org.alpha.godzila.util.PrintUtil;
...
public class FtpInputFormat extends BaseRichInputFormat {
    ...
    public void closeInputFormat() {
        ...
        allCounters.forEach(
                (key, value) -> {
                    if (key.startsWith(ConfigConstants.FTP_COUNTER_PREFIX)) {
