...
import org.alpha.godzila.connector.ftp.client.ZipInputStream;
import org.alpha.godzila.connector.ftp.config.ConfigConstants;
import org.alpha.godzila.connector.ftp.enums.FileType;
import org.alpha.godzila.connector.ftp.handler.Position;
import org.alpha.godzila.connector.ftp.client.Data;
import org.alpha.godzila.connector.ftp.config.FtpConfig;
import org.alpha.godzila.connector.ftp.extend.ftp.File;
import org.alpha.godzila.connector.ftp.extend.ftp.FtpParseException;
import org.alpha.godzila.connector.ftp.extend.ftp.IFormatConfig;
import org.alpha.godzila.connector.ftp.extend.ftp.concurrent.FtpFileSplit;
import org.alpha.godzila.connector.ftp.extend.ftp.format.IFileReadFormat;
import org.alpha.godzila.connector.ftp.handler.DTFtpHandler;
import org.alpha.godzila.connector.ftp.handler.FtpHandler;
import org.alpha.godzila.connector.ftp.handler.FtpHandlerFactory;
import org.alpha.godzila.connector.ftp.iformat.IFormatFactory;
...
public class FtpFileReader {
    ...
    private String getMetricName(String action) {
        switch (action) {
            case "tickStart":
            case "tickEnd":
                return ConfigConstants.FTP_COUNTER_PREFIX + "_read_duration";

            case "readLines":
                return ConfigConstants.FTP_COUNTER_PREFIX + "_read_lines";

            case "readBytes":
                return ConfigConstants.FTP_COUNTER_PREFIX + "_read_bytes";
