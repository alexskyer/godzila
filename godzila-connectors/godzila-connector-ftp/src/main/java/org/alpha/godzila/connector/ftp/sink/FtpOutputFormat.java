...
import org.alpha.godzila.connector.ftp.enums.CompressType;
...
import org.alpha.godzila.enums.SizeUnitType;
import org.alpha.godzila.sink.WriteMode;
import org.alpha.godzila.sink.format.BaseFileOutputFormat;
...
public class FtpOutputFormat extends BaseFileOutputFormat {
    ...
    protected void nextBlock() {
        ...
        try {
            ...
            throw new GodzilaRuntimeException(ExceptionUtil.getErrorMessage(e));
        }
    ...
    protected void checkCurrentFileSize() {
        ...
        if (!isCompress) {
            try {
                ...
                throw new GodzilaRuntimeException("flush failed when check fileSize");
            }
        }
    ...
    public void closeInternal() throws IOException {
        ...
        try {
            ...
            throw new GodzilaRuntimeException("can't close source.", e);
        } finally {
            this.ftpHandler.logoutFtpServer();
        }
    }
    ...
    protected long getCurrentFileSize() {
        ...
        try {
            ...
            throw new GodzilaRuntimeException("can't get file size from ftp, file = " + path, e);
        }
    }
