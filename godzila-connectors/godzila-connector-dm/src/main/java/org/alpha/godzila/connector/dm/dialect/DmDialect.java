...
package org.alpha.godzila.connector.dm.dialect;

import org.alpha.godzila.config.CommonConfig;
import org.alpha.godzila.connector.dm.converter.DmRawTypeConverter;
import org.alpha.godzila.connector.dm.converter.DmSqlConverter;
import org.alpha.godzila.connector.dm.converter.DmSyncConverter;
...
public class DmDialect implements JdbcDialect {
    ...
    public Optional<String> getReplaceStatement(
        ...
        throw new GodzilaRuntimeException("dm does not support replace sql");
    }
